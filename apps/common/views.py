...
SETTINGS_LIST = (
    ...
    ('server_talk', 'INVENTORY_QUERY_INTERVAL', 'SERVER_INVENTORY_QUERY_INTERVAL'),
    ('server_talk', 'SIBLINGS_QUERY_INTERVAL', 'SERVER_SIBLINGS_QUERY_INTERVAL'),
    ('server_talk', 'HEARTBEAT_FAILURE_THRESHOLD', 'SERVER_HEARTBEAT_FAILURE_THRESHOLD'),
    ('server_talk', 'TIMEOUT', 'SERVER_TIMEOUT'),
)
